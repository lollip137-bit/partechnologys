...
export const SERVICE_TREE: { cat: string; blurb: string; items: string[] }[] = [
  ...
  { cat: 'Industry Solutions', blurb: 'Systems built for how your sector actually works.', items: ['Healthcare', 'Construction', 'Real Estate', 'Retail', 'Manufacturing', 'Logistics', 'Education', 'Finance', 'Hospitality', 'Startups'] },
